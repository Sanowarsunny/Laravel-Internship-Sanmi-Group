...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="backend/common/assets/images/favicon.ico" />

    <!-- Library / Plugin Css Build -->
    <link rel="stylesheet" href="backend/common/assets/css/core/libs.min.css" />

    <!-- Aos Animation Css -->
    <link rel="stylesheet" href="backend/common/assets/vendor/aos/dist/aos.css" />

    <!-- Hope Ui Design System Css -->
    <link rel="stylesheet" href="backend/common/assets/css/hope-ui.min.css?v=2.0.0" />

    <!-- Custom Css -->
    <link rel="stylesheet" href="backend/common/assets/css/custom.min.css?v=2.0.0" />

    <!-- Dark Css -->
    <link rel="stylesheet" href="backend/common/assets/css/dark.min.css" />

    <!-- Customizer Css -->
    <link rel="stylesheet" href="backend/common/assets/css/customizer.min.css" />

    <!-- RTL Css -->
    <link rel="stylesheet" href="backend/common/assets/css/rtl.min.css" />
...
<body class="  ">
    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="backend/common/dashboard/index.html" class="navbar-brand">
                <!--Logo start-->
                <!--logo End-->
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/index-horizontal.html">
                                    <i class="icon">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/index-dual-horizontal.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/index-dual-compact.html">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/index-boxed.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/index-boxed-fancy.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/special-pages/billing.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/special-pages/calender.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/special-pages/kanban.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/special-pages/pricing.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/special-pages/rtl-support.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/special-pages/timeline.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="backend/common/dashboard/auth/sign-in.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="backend/common/dashboard/auth/sign-up.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="backend/common/dashboard/auth/confirm-mail.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="backend/common/dashboard/auth/lock-screen.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="backend/common/dashboard/auth/recoverpw.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/app/user-profile.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/app/user-add.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/app/user-list.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/errors/error404.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/errors/error500.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/errors/maintenance.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="backend/common/dashboard/admin.html">
                            <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-widget" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/widget/widgetbasic.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/widget/widgetchart.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/widget/widgetcard.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-maps" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/maps/google.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/maps/vector.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-form" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/form/form-element.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/form/form-wizard.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/form/form-validation.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-table" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/table/bootstrap-table.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/table/table-data.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item mb-5">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-icons" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/icons/solid.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/icons/outline.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="backend/common/dashboard/icons/dual-tone.html">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
            ...
            <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
                <div class="container-fluid navbar-inner">
                    ...
                    <div class="input-group search-input">
                        ...
                        <input type="search" class="form-control" placeholder="Searchbackend/common.">
                    </div>
                        ...
                        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="search-toggle nav-link" id="dropdownMenuButton2"
                                    ...
                                    <img src="backend/common/assets/images/Flag/flag001.png"
                                        ...
                                        <div class="p-0 ">
                                            <ul class="p-0 list-group list-group-flush">
                                                <li class="iq-sub-card list-group-item"><a class="p-0"
                                                        href="#"><img
                                                            src="backend/common/assets/images/Flag/flag-03.png"
                                                            alt="img-flaf" class="img-fluid me-2"
                                                            style="width: 15px;height: 15px;min-width: 15px;" />Spanish</a>
                                                </li>
                                                <li class="iq-sub-card list-group-item"><a class="p-0"
                                                        href="#"><img
                                                            src="backend/common/assets/images/Flag/flag-04.png"
                                                            alt="img-flaf" class="img-fluid me-2"
                                                            style="width: 15px;height: 15px;min-width: 15px;" />Italian</a>
                                                </li>
                                                <li class="iq-sub-card list-group-item"><a class="p-0"
                                                        href="#"><img
                                                            src="backend/common/assets/images/Flag/flag-02.png"
                                                            alt="img-flaf" class="img-fluid me-2"
                                                            style="width: 15px;height: 15px;min-width: 15px;" />French</a>
                                                </li>
                                                <li class="iq-sub-card list-group-item"><a class="p-0"
                                                        href="#"><img
                                                            src="backend/common/assets/images/Flag/flag-05.png"
                                                            alt="img-flaf" class="img-fluid me-2"
                                                            style="width: 15px;height: 15px;min-width: 15px;" />German</a>
                                                </li>
                                                <li class="iq-sub-card list-group-item"><a class="p-0"
                                                        href="#"><img
                                                            src="backend/common/assets/images/Flag/flag-06.png"
                                                            alt="img-flaf" class="img-fluid me-2"
                                        ...
                                        <div class="p-0 card-body">
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                        src="backend/common/assets/images/shapes/01.png"
                                                        alt="">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <div class="">
                                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                            src="backend/common/assets/images/shapes/02.png"
                                                            alt="">
                                                    </div>
                                                    <div class="ms-3 w-100">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                        src="backend/common/assets/images/shapes/03.png"
                                                        alt="">
                                                    <div class="ms-3 w-100">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                        src="backend/common/assets/images/shapes/04.png"
                                                        alt="">
                                        ...
                                        <div class="p-0 card-body ">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <div class="">
                                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                            src="backend/common/assets/images/shapes/05.png"
                                                            alt="">
                                                    </div>
                                                    <div class="ms-3">
                            ...
                            <li class="nav-item dropdown">
                                <a class="py-0 nav-link d-flex align-items-center" href="#"
                                    ...
                                    aria-expanded="false">
                                    <img src="backend/common/assets/images/avatars/01.png" alt="User-Profile"
                                        class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="backend/common/assets/images/avatars/avtar_1.png" alt="User-Profile"
                                        class="theme-color-purple-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="backend/common/assets/images/avatars/avtar_2.png" alt="User-Profile"
                                        class="theme-color-blue-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="backend/common/assets/images/avatars/avtar_4.png" alt="User-Profile"
                                        class="theme-color-green-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="backend/common/assets/images/avatars/avtar_5.png" alt="User-Profile"
                                        class="theme-color-yellow-img img-fluid avatar avatar-50 avatar-rounded">
                                    <img src="backend/common/assets/images/avatars/avtar_3.png" alt="User-Profile"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item"
                                            href="backend/common/dashboard/app/user-profile.html">Profile</a></li>
                                    <li><a class="dropdown-item"
                                            href="backend/common/dashboard/app/user-privacy-setting.html">Privacy
                                            Setting</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item"
                                            href="backend/common/dashboard/auth/sign-in.html">Logout</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="footer-body">
                <ul class="left-panel list-inline mb-0 p-0">
                    <li class="list-inline-item"><a
                            href="backend/common/dashboard/extra/privacy-policy.html">Privacy Policy</a></li>
                    <li class="list-inline-item"><a
                            href="backend/common/dashboard/extra/terms-of-service.html">Terms of Use</a></li>
                </ul>
        ...
        <div class="offcanvas-body data-scrollbar">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                        <div class="text-center">
                            <img src="backend/common/assets/images/settings/dark/03.png" alt="mini"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-mini">
                            <img src="backend/common/assets/images/settings/light/03.png" alt="mini"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-mini">
                            <span class="mt-2">Mini</span>
                        </div>
                        <div class="text-center">
                            <img src="backend/common/assets/images/settings/dark/04.png" alt="hover"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-hover"
                                data-extra-value="sidebar-mini">
                            <img src="backend/common/assets/images/settings/light/04.png" alt="hover"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-hover"
                                data-extra-value="sidebar-mini">
                        ...
                        <div class="text-center">
                            <img src="backend/common/assets/images/settings/dark/05.png" alt="boxed"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-boxed">
                            <img src="backend/common/assets/images/settings/light/05.png" alt="boxed"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-boxed">
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div class="text-center">
                            <img src="backend/common/assets/images/settings/dark/06.png" alt="rounded-one-side"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded">
                            <img src="backend/common/assets/images/settings/light/06.png" alt="rounded-one-side"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded">
                            <span class="mt-2">Rounded One Side</span>
                        </div>
                        <div class="text-center">
                            <img src="backend/common/assets/images/settings/dark/07.png" alt="rounded-all"
                                class="mode dark-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                            <img src="backend/common/assets/images/settings/light/07.png" alt="rounded-all"
                                class="mode light-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                            <span class="mt-2">Rounded All</span>
                        </div>
                        <div class="text-center">
                            <img src="backend/common/assets/images/settings/dark/08.png" alt="pill-one-side"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill">
                            <img src="backend/common/assets/images/settings/light/09.png" alt="pill-one-side"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill">
                            <span class="mt-2">Pill One Side</span>
                        </div>
                        <div class="text-center">
                            <img src="backend/common/assets/images/settings/dark/09.png" alt="pill-all"
                            ...
                            <img src="backend/common/assets/images/settings/light/08.png" alt="pill-all"
                    ...
                    <div class="d-grid gap-3 grid-cols-2 ">
                        <div class=" text-center">
                            <img src="backend/common/assets/images/settings/dark/11.png" alt="image"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
                                data-value="nav-glass">
                            <img src="backend/common/assets/images/settings/light/10.png" alt="image"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
                                data-value="nav-glass">
                        ...
                        <div class="text-center">
                            <img src="backend/common/assets/images/settings/dark/10.png" alt="color"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar-header" data-name="navbar-type"
                                data-value="navs-bg-color">
                            <img src="backend/common/assets/images/settings/light/11.png" alt="color"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar-header" data-name="navbar-type"
                                data-value="navs-bg-color">
                        ...
                        <div class=" text-center">
                            <img src="backend/common/assets/images/settings/dark/12.png" alt="sticky"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
                                data-value="navs-sticky">
                            <img src="backend/common/assets/images/settings/light/12.png" alt="sticky"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
                                data-value="navs-sticky">
                        ...
                        <div class="text-center">
                            <img src="backend/common/assets/images/settings/dark/13.png" alt="transparent"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
                                data-value="navs-transparent">
                            <img src="backend/common/assets/images/settings/light/13.png" alt="transparent"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
                                data-value="navs-transparent">
    ...
    <script src="backend/common/assets/js/core/libs.min.js"></script>

    <!-- External Library Bundle Script -->
    <script src="backend/common/assets/js/core/external.min.js"></script>

    <!-- Widgetchart Script -->
    <script src="backend/common/assets/js/charts/widgetcharts.js"></script>

    <!-- mapchart Script -->
    <script src="backend/common/assets/js/charts/vectore-chart.js"></script>
    <script src="backend/common/assets/js/charts/dashboard.js"></script>

    <!-- fslightbox Script -->
    <script src="backend/common/assets/js/plugins/fslightbox.js"></script>

    <!-- Settings Script -->
    <script src="backend/common/assets/js/plugins/setting.js"></script>

    <!-- Slider-tab Script -->
    <script src="backend/common/assets/js/plugins/slider-tabs.js"></script>

    <!-- Form Wizard Script -->
    <script src="backend/common/assets/js/plugins/form-wizard.js"></script>

    <!-- AOS Animation Plugin-->
    <script src="backend/common/assets/vendor/aos/dist/aos.js"></script>

    <!-- App Script -->
    <script src="backend/common/assets/js/hope-ui.js" defer></script>
